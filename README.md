<p align="center">
    <img alt="Goenv Logo" src="/static/logo.png?v=1.21.0" width="200" />
    ...
    <p align="center">
        ...
        <a href="https://github.com/clivern/Goenv/releases">
            <img src="https://img.shields.io/badge/Version-v1.21.0-red.svg">
        </a>
        <a href="https://goreportcard.com/report/github.com/clivern/Goenv">
            <img src="https://goreportcard.com/badge/github.com/clivern/Goenv?v=1.21.0">
        </a>
...
Install a new `go` version `1.24.2` and set as a global
